...
def stats():
    print('|{}| {}/{}HP | COINS:{} | ATTACK:{} | SPEED:{} | {}/{}xp'.format(char.name,char.hp,char.fullHp,char.coins,char.attk,char.speed,char.xp,char.fullXp))
    print('----' + char.location + '----')
      ...
      # Dungeon
        ...
        while True:
          ...
          for x in range(len(monsters)):
              ...
              print('NPC#:{}\n{}\nlevel:{}\n'.format(count,currentMonster.name,currentMonster.attk))
              count += 1
              
          # User input
          answer = int(input('Choose a monster to fight: {}-{}:'.format(1,len(monsters))))
